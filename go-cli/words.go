...
func registerSDKWords(r *eng.Registry, client *sdk.NekosiaNekoSDK) {
...
func runOp(client *sdk.NekosiaNekoSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
