# NekosiaNeko Golang SDK Reference

Complete API reference for the NekosiaNeko Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *NekosiaNekoSDK`
...
#### `Booru(data map[string]any) NekosiaNekoEntity`

Create a new `Booru` entity instance. Pass `nil` for no initial data.

#### `Image(data map[string]any) NekosiaNekoEntity`
