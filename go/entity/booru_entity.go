...
import (
	...
	vs "github.com/voxgig-sdk/nekosia-neko-sdk/go/utility/struct"
)

type BooruEntity struct {
	name    string
	client  *core.NekosiaNekoSDK
...
func NewBooruEntity(client *core.NekosiaNekoSDK, entopts map[string]any) *BooruEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BooruEntity) GetName() string { return e.name }
...
func (e *BooruEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BooruEntity) Deleted() bool {
	return e.deleted
}


func (e *BooruEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBooruEntity(e.client, opts)
}

func (e *BooruEntity) Data(args ...any) any {
...
func (e *BooruEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *BooruEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BooruEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *BooruEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
func (e *BooruEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BooruEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BooruEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
