...
// instead of `sdk.NewNekosiaNekoSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *NekosiaNekoSDK  { return NewNekosiaNekoSDK(nil) }
func Test() *NekosiaNekoSDK { return TestSDK(nil, nil) }
