...
const testSeed = `map[string]any{"entity": map[string]any{"booru": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "image": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
