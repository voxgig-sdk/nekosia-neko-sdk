...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/nekosia-neko` | `npm install @voxgig-sdk/nekosia-neko` |
| Python | `voxgig-sdk-nekosia-neko` | `pip install voxgig-sdk-nekosia-neko` |
| PHP | `voxgig-sdk/nekosia-neko` | `composer require voxgig-sdk/nekosia-neko` |
| Golang | `github.com/voxgig-sdk/nekosia-neko-sdk/go` | `go get github.com/voxgig-sdk/nekosia-neko-sdk/go` |
| Ruby | `voxgig-sdk-nekosia-neko` | `gem install voxgig-sdk-nekosia-neko` |
| Lua | `voxgig-sdk-nekosia-neko` | `luarocks install voxgig-sdk-nekosia-neko` |
