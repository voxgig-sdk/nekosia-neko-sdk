...
function envOverride(m) {
    if ('TRUE' === process.env.NEKOSIA_NEKO_TEST_LIVE ||
        'TRUE' === process.env.NEKOSIA_NEKO_TEST_OVERRIDE) {
    ...
    m.NEKOSIA_NEKO_TEST_EXPLAIN = process.env.NEKOSIA_NEKO_TEST_EXPLAIN || m.NEKOSIA_NEKO_TEST_EXPLAIN;
    return m;
}
