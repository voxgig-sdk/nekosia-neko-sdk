...
|---|---|---|
| `ts/` | @voxgig-sdk/nekosia-neko-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/nekosia-neko-sdk \
      --repository voxgig-sdk/nekosia-neko-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/nekosia-neko-sdk` shows it, and
`npm trust revoke @voxgig-sdk/nekosia-neko-sdk --id=<id>` removes it.
