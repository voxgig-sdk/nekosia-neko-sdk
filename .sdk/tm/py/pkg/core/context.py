...
from projectname_sdk.core.control import NekosiaNekoControl
...
class NekosiaNekoContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, NekosiaNekoSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, NekosiaNekoResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, NekosiaNekoResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return NekosiaNekoError(code, msg, self)
