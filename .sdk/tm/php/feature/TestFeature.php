...
// NekosiaNeko SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class NekosiaNekoTestFeature extends NekosiaNekoBaseFeature
{
    ...
    public function init(NekosiaNekoContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (NekosiaNekoContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = NekosiaNekoParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (NekosiaNekoContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(NekosiaNekoContext $ctx, $op, $args): array
    {
