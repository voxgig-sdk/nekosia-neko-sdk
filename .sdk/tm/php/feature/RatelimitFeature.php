...
// NekosiaNeko SDK ratelimit feature
...
class NekosiaNekoRatelimitFeature extends NekosiaNekoBaseFeature
{
    ...
    private function _acquire(NekosiaNekoContext $ctx): void
    {
    ...
    private function _track(NekosiaNekoContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
