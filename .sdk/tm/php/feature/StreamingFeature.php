...
// NekosiaNeko SDK streaming feature
...
class NekosiaNekoStreamingFeature extends NekosiaNekoBaseFeature
{
    ...
    private function _iterate(NekosiaNekoResult $result): \Generator
    {
    ...
    private function _streamable(NekosiaNekoContext $ctx): bool
    {
