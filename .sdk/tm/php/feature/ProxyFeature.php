...
class NekosiaNekoProxyFeature extends NekosiaNekoBaseFeature
{
    ...
    public function init(NekosiaNekoContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NekosiaNekoContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
