...
class NekosiaNekoRbacFeature extends NekosiaNekoBaseFeature
{
    ...
    private function _required(NekosiaNekoContext $ctx): ?string
    {
    ...
    private function _reject(NekosiaNekoContext $ctx, string $required): void
    {
    ...
    private function _track(NekosiaNekoContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
