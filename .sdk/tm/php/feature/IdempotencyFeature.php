...
// NekosiaNeko SDK idempotency feature
...
class NekosiaNekoIdempotencyFeature extends NekosiaNekoBaseFeature
{
    ...
    private function _mutating(NekosiaNekoContext $ctx): bool
    {
