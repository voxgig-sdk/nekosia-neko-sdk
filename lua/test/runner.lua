...
function runner.env_override(m)
  local live = runner.getenv("NEKOSIANEKO_TEST_LIVE")
  local override = runner.getenv("NEKOSIANEKO_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("NEKOSIANEKO_TEST_EXPLAIN")
