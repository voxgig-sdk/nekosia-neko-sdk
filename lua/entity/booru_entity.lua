...
local BooruEntity = {}
BooruEntity.__index = BooruEntity


function BooruEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BooruEntity)
  self._name = "booru"
  self._client = client
...
function BooruEntity:get_name()
  return self._name
end


function BooruEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BooruEntity.new(self._client, opts)
end
...
function BooruEntity:mark_deleted()
  self._deleted = true
end


function BooruEntity:deleted()
  return true == self._deleted
end


function BooruEntity:data_set(args)
  if args ~= nil then
...
function BooruEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BooruEntity:match_set(args)
  if args ~= nil then
...
function BooruEntity:match_get()
...
function BooruEntity:stream(action, args, callopts)
...
function BooruEntity:_run_op(ctx, post_done)
  local utility = self._utility
