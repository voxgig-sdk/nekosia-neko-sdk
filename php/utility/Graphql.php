...
// NekosiaNeko SDK utility: graphql
//
...
class NekosiaNekoGraphql
{
    ...
    // equivalent.
    public static function body(NekosiaNekoContext $ctx): mixed
    {
    ...
    public static function errors(NekosiaNekoContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
