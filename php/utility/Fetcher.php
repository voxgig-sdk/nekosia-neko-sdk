...
// NekosiaNeko SDK utility: fetcher

class NekosiaNekoFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NekosiaNekoSDK/1.0)';
    ...
    public static function call(NekosiaNekoContext $ctx, string $fullurl, array $fetchdef): array
    {
