...
// NekosiaNeko SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class NekosiaNekoTransformResponse
{
    public static function call(NekosiaNekoContext $ctx): mixed
    {
        ...
        $transform = NekosiaNekoHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
