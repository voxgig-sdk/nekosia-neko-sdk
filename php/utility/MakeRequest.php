...
// NekosiaNeko SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class NekosiaNekoMakeRequest
{
    public static function call(NekosiaNekoContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new NekosiaNekoResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new NekosiaNekoResponse($fetched);
        } else {
