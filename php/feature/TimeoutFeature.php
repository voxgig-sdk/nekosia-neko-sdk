...
// NekosiaNeko SDK timeout feature
...
class NekosiaNekoTimeoutFeature extends NekosiaNekoBaseFeature
{
    ...
    private function _with_timeout(NekosiaNekoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NekosiaNekoContext $_ctx, float $ms): void
    {
        $client = $this->client;
