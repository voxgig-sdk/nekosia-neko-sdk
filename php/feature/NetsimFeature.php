...
// NekosiaNeko SDK netsim feature
...
class NekosiaNekoNetsimFeature extends NekosiaNekoBaseFeature
{
    ...
    private function _simulate(NekosiaNekoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NekosiaNekoContext $ctx, array $applied): void
    {
        $client = $this->client;
