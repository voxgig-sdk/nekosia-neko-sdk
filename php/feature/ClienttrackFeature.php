...
// NekosiaNeko SDK clienttrack feature
...
class NekosiaNekoClienttrackFeature extends NekosiaNekoBaseFeature
{
    ...
    public function PostConstruct(NekosiaNekoContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'NekosiaNeko-SDK';
