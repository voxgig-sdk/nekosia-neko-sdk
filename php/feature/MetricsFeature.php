...
// NekosiaNeko SDK metrics feature
...
class NekosiaNekoMetricsFeature extends NekosiaNekoBaseFeature
{
    ...
    private function _record(NekosiaNekoContext $ctx, bool $ok): void
    {
