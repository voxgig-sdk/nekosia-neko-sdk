...
// NekosiaNeko SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = NekosiaNekoOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(NekosiaNekoOmni::structfix($now, Struct::undef()))
                        !== json_encode(NekosiaNekoOmni::structfix($val, Struct::undef()))) {
