...
// NekosiaNeko SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NekosiaNekoSDK::test)
...
{
    private const SDK_CLASS = 'NekosiaNekoSDK';
    ...
    private const SDK_BASE = 'nekosianeko_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../nekosianeko_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
