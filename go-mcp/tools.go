...
type Args struct {
	Entity string         `json:"entity" jsonschema:"booru | image"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.NekosiaNekoSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "nekosia-neko_list",
		Description: "List records from NekosiaNeko. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "nekosia-neko_load",
		Description: "Load a single record from NekosiaNeko. " +
...
func runOp(client *sdk.NekosiaNekoSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.NekosiaNekoSDK, name string) (sdk.NekosiaNekoEntity, error) {
	switch strings.ToLower(name) {
	case "booru":
		return client.Booru(nil), nil
	case "image":
