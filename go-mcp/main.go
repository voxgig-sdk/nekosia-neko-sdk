// Command NekosiaNeko-mcp is an MCP server exposing the NekosiaNeko
// SDK as MCP tools.
//
// Two tools are registered:
//
//	NekosiaNeko_list  — list records of an entity
//	NekosiaNeko_load  — load a single record of an entity
//
