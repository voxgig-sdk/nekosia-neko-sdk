# NekosiaNeko SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NekosiaNekoSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NekosiaNekoSDK(...) and NekosiaNekoSDK.test(...) become
#      NekosiaNekoSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "nekosianeko_sdk"
_SDK_CLASS = "NekosiaNekoSDK"
