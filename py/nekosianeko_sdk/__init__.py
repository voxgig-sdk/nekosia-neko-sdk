...
from nekosianeko_sdk.utility import register

# Load features
from nekosianeko_sdk.feature.base_feature import NekosiaNekoBaseFeature
from nekosianeko_sdk.features import _has_feature, _make_feature
...
class NekosiaNekoSDK:
    ...
    def get_utility(self):
        return NekosiaNekoUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("NekosiaNekoSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Booru(self, data=None) -> "BooruEntity":
        ...
        from nekosianeko_sdk.entity.booru_entity import BooruEntity
        return BooruEntity(self, data)


    def Image(self, data=None) -> "ImageEntity":
        """Entity factory: client.Image().list() / client.Image().load({"id": ...})."""
        from nekosianeko_sdk.entity.image_entity import ImageEntity
